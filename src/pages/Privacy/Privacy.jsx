    ...
    <div className="container m-auto mb-5 max-w-[800px]">
      ...
      <div className="m-auto">
        ...
        <div className="my-8 text-center">
          <button className="rounded-full bg-gradient-to-r from-dark-green to-green px-8 py-4 text-white hover:from-green hover:to-dark-green hover:scale-[1.1] transition-all duration-300">
            Contacto
          </button>
        </div>
      </div>
