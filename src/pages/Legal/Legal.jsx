    ...
    <div className="container m-auto mb-5 max-w-[800px]">
      <div>
        ...
        <p className="my-2">
          ...
          regular el acceso y uso, y en general, la relación entre este website
        ...
        <p className="my-2">
          ...
          protección de datos personales, le informamos de que la presente
          página web es propiedad de CONSUPAN S.L.U. (en adelante FANS) :
        </p>
        <p className="my-2">
        ...
        <h3 className="my-2">MARCO NORMATIVO</h3>
        <p className="my-2">
        ...
        <h3 className="my-2">DELEGADO DE PROTECCIÓN DE DATOS </h3>
        <p className="my-2">
          ...
          asociado a las operaciones de tratamiento y previo análisis interno ha
          llegado a la conclusión de que no tiene obligación legal de designar
          un delegado de protección de datos.
        </p>
        <p className="my-2">
          No obstante FANS para garantizar y demostrar que el tratamiento se
          lleva a cabo bajo las disposiciones del RGPD se han establecido
          protocolos y herramientas de rendición de cuentas tales como
          evaluaciones de impacto, revisiones trimestrales, auditoría anual…
          etc. Asimismo, dispone de un equipo encargado de garantizar el
          cumplimiento de la normativa sobre protección de datos personales, así
          como informar y asesorar a los interesados y cooperar con la autoridad
          de control.
        </p>

        <h3 className="my-2">QUÉ DATOS LE VAMOS A SOLICITAR</h3>
        <p className="my-2">
          ...
          solicitar aquella información que sea estrictamente adecuada,
          pertinente y limitada a lo necesario para ofrecerle los servicios más
          abajo descritos.
        </p>
        <p className="my-2">Estos son los datos que le podemos solicitar:</p>
        <ul>
          <li className="my-2">
            Detalles de contacto: nombre, dirección postal, número de teléfono,
            email, DNI, NIF o documento identificativo, firma.
          </li>
          <li className="my-2">
        ...
        <p className="my-2">
          Los representantes legales de las personas menores de edad tienen
          plena responsabilidad en el acceso a contenidos y servicios de
          internet por dichos menores, Para ello disponen de programas
          informáticos y herramientas de bloqueo y filtro en el acceso a
          contenidos o sitios web no apropiados para menores.
        </p>

        <h3 className="my-2">CÓMO OBTENEMOS SUS DATOS </h3>
        <p className="my-2">
        ...
        <p>
          ...
          RGPD sustituye la obligación de inscribir ficheros por la creación de
          un registro de actividades de tratamiento que debe ofrecer toda la
          información nece saria para conocer el flujo de datos y las acciones
        ...
        <p>
          FANS elabora un perfil comercial en base a la información que usted
          nos facilita. No se tomarán decisiones automatizadas en base a dicho
          perfil.
        </p>
        ...
        <ul>
          ...
          <li>
            Enviarle información sobre productos y/o servicios de su interés.
          </li>
          <li>Actualizar nuestros registros. </li>
          <li>Verificar su identidad para fines de cumplimiento normativo. </li>
        </ul>
        <p>
          Usted puede optar por no recibir nuestras comunicaciones electrónicas,
          puede solicitarlo enviando un email a fanscoffeebakery@gmail.com con
          el siguiente asunto “no deseo recibir comunicaciones comerciales”.
        </p>

        <h3>¿POR CUÁNTO TIEMPO CONSERVAREMOS SUS DATOS? </h3>
        <p>
          Los datos personales que usted nos proporciona se conservarán durante
          el tiempo necesario para las finalidades de tratamiento para las que
          han sido recogidos y mientras usted no solicite su supresión. En
          concreto los plazos establecidos en función de la finalidad son los
          siguientes:
        </p>
        <ul>
          <li>
          ...
          <li>
            <strong>Participar en procesos de selección:</strong> los datos
            serán conservados por un plazo no superior a 2 años.
          </li>
          <li>
            <strong>Confeccionar estadísticas:</strong> los datos serán
            conservados de forma indefinida en tanto el interesado no solicite
            su supresión.
          </li>
          <li>
          ...
          <li>
            ...
            mantendrán en el sistema de forma indefinida en tanto el interesado
        ...
        <p>
          Podremos conservar su información personal incluso después de
          finalizar esta necesidad si fuera necesario para cumplir con alguna
          obligación legal, los datos permanecerían bloqueados el tiempo
          necesario para cumplir el periodo marcado por la Ley para proceder
          luego a su eliminación.
        </p>
        ...
        <p>
          FANS se preocupa por la seguridad de los usuarios de su web y para
          ello mantiene actualizado el software, aplica un firewall que se ocupa
          de detectar y mitigar amenazas y realiza copias de seguridad para
        ...
        <p>
          ...
          <strong>acceder</strong> a sus datos personales, así como a solicitar
          la <strong>rectificación</strong> de los datos inexactos o, en su caso
          a solicitar la <strong>supresión</strong> cuando, entre otros motivos,
        ...
        <p>
          ...
          de sus datos. FANS dejará de tratar los datos, salvo por motivos
          legítimos imperiosos, o en el ejercicio o la defensa de posibles
          reclamaciones.
        </p>
        <p>
          Usted tiene derecho a solicitar la <strong>portabilidad</strong> de
          sus datos así como a <strong>retirar el consentimiento</strong> para
          su tratamiento en cualquier momento.
        </p>
        <p>
          Usted puede ejercer sus derechos contactando con FANS, por medio de
          los datos de contacto anteriormente mencionados, indicando como asunto
          “LOPD, Derechos” y adjuntando fotocopia de su Documento Nacional de
          Identidad o cualquier otro medio válido en derecho.
        </p>
        <p>
          Usted tiene derecho a <strong>presentar una reclamación</strong> ante
          la
          <a href="https://www.aepd.es/es" class="link">
        ...
        <h3>
          ¿QUÉ OBLIGACIONES TIENE USTED CON RESPECTO A LOS DATOS QUE NOS
          FACILITA?
        </h3>
        <p>
          Usted como propietario de sus datos, debe garantizar la veracidad de
          los mismos y se compromete a comunicar cualquier cambio que se
          produzca sobre ellos.
        </p>
        <p>
        ...
        <p>
          Como usuario usted se compromete a que la información facilitada a
          FANS sobre terceras personas ha sido recabada de acuerdo a la
          normativa vigente y habiendo recabado el consentimiento del titular de
          los datos.
        </p>
        <p>
          Como usuario de esta web se compromete a utilizar el website, los
          servicios, los contenidos y este aviso legal de conformidad con la
          ley, la moral, las buenas costumbres y el orden público.
        </p>
        <p>
          Usted se compromete a no realizar actividades publicitarias,
          promocionales o de explotación comercial a través de la web, ni
          utilizar los contenidos y, en particular, la información obtenida a
          través del Portal para remitir publicidad, enviar mensajes con fines
          de venta directa o con cualquier otro fin comercial, ni para recoger o
        ...
        <p>
          ...
          publicadas en el momento de utilización de la web o de los servicios.
          Le rogamos lea atentamente esta información antes de proceder a su
          uso, así como periódicamente, a fin de mantenerse totalmente
          informado.
        </p>
        <p>
          Si usted tiene alguna pregunta en relación con este Aviso Legal puede
          contactar con nosotros en el siguiente email:
          fanscoffeebakery@gmail.com.
        </p>
        ...
        <p>
          ...
          manual y automatizado de los mismos por parte de FANS en la forma y
          para las finalidades indicadas en la presente Política de Protección
          de Datos Personales.
        </p>
        <p>
          Puede anular cualquier autorización cuando lo desee dirigiéndose a
          FANS.
        </p>
        ...
        <p>
          Los enlaces contenidos en nuestros portales pueden dirigir a
          contenidos Web de terceros. El objetivo de dichos enlaces es
          únicamente facilitarle la búsqueda de los recursos que le puedan
          interesar a través de Internet. No obstante, dichas páginas no
          pertenecen a FANS , ni hace una revisión de sus contenidos y, por
          ello, FANS no asume ninguna responsabilidad por el contenido,
          informaciones o servicios que pudieran aparecer en dichos sitios, que
          tendrán exclusivamente carácter informativo y que en ningún caso
          implican relación alguna entre FANS y a las personas o entidades
          titulares de tales contenidos o titulares de los sitios donde se
          encuentren. FANS tampoco puede hacerse responsable del funcionamiento
          de la página enlazada o de los posibles daños que puedan derivarse del
        ...
        <ol>
          ...
          <li>
            ...
            contener marca, denominación, logotipo, eslogan u otros signos
            distintivos pertenecientes a FANS excepto aquellos signos que formen
            parte del mismo hiperenlace.
          </li>
        </ol>
        ...
        <p>
          FANS prohíbe expresamente la realización de “framings” o la
          utilización por parte de terceros de cualesquiera otros mecanismos que
          alteren el diseño, configuración original o contenidos de nuestros
          portales.
        </p>
        <p>
        ...
        <p>
          Respecto a las citas de productos o servicios de terceros, FANS
          reconoce a favor de sus titulares los correspondientes derechos de
          propiedad industrial o intelectual, no implicando su sola mención o
          aparición en la Web la existencia de derechos ni de responsabilidad
          alguna sobre los mismos, como tampoco respaldo, patrocinio o
          recomendación.
        </p>

        <h3 className="my-4 text-xl">RESPONSABILIDAD </h3>
        <p>
          FANS no garantiza la inexistencia de errores en el acceso a la Web, en
          su contenido, ni que éste se encuentre actualizado, aunque se
          compromete a realizar los mayores esfuerzos para, en su caso,
        ...
        <p>
          ...
          documentos almacenados en el mismo, como consecuencia de la presencia
          de virus en el ordenador del usuario utilizado para la conexión a los
          servicios y contenidos de la Web, de un mal funcionamiento del
          navegador o del uso de versiones no actualizadas del mismo.
        </p>
        <p>
          FANS no se hace responsable de la información y contenidos
          ...
          permita a terceros publicar contenidos de forma independiente en esta
          Web.
        </p>
        <p>
          ...
          colaborando de forma activa en la retirada o en su caso bloqueo de
          todos aquellos contenidos que pudieran afectar o contravenir la
          legislación nacional, o internacional, derechos de terceros o la moral
          y el orden público. En caso de que usted considere que existe en el
          sitio web algún contenido que pudiera ser susceptible de esta
          clasificación, rogamos contacte con FANS.
        </p>
        <p>
          ...
          en su portal, por lo que en ningún caso podrá derivarse efecto
          jurídico vinculante de las mismas.
        </p>
      </div>
    </div>
  )
