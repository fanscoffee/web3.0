...
function Header() {
  ...
  return (
    <header className="fixed left-0 top-0 w-full bg-neutral-100 text-center text-neutral-600 shadow-md dark:bg-neutral-600 dark:text-neutral-200 lg:text-left">
